...
public static class DomainExtensions
{
    ...
    public static void ConfigureDomainMetaData(this LayerConfigurator configurator, Action<DomainConventionProcessor> configuration) => configurator.Configure(configuration);
