...
public static class DomainExtensions
{
    ...
    public static void ConfigureDomainMetaData(this LayerConfigurator configurator, Action<DomainMetadataProcessor> configuration) => configurator.Configure(configuration);
