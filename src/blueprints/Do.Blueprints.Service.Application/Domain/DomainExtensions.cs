...
public static class DomainExtensions
{
    ...
    public static void ConfigureDomainServiceDescriptor(this LayerConfigurator configurator, Action<DomainServiceDescriptor> configuration) => configurator.Configure(configuration);
}
