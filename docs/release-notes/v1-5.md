...
- `Bake.vue` can now forwards all slots to component, enabling dynamic
  components to be used with slots
...
- New extension members are introduced to simplify UI building
  ...
  - `Add(newGroupKey, oldGroupKeys[])` support to allow grouping inputs under
    form page
