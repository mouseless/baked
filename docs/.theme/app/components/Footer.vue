<template>
  <div class="mt-md border-t-2 border-bg-second">
    <footer
      class="
        flex flex-row items-start justify-between
        my-sm mx-auto text-fg-third box-border
      ...
      "
    >
      <div class="logo text-[smaller] font-heading my-sm mx-0">
        <NuxtLink to="/" class="block h-3">
          <img class="baked logo mono inline-block h-3 opacity-50">
        </NuxtLink>
        <span class="inline-block mt-sm">Copyright (c) 2026 Mouseless - MIT License</span>
      </div>
      <nav class="text-[smaller] font-heading text-right max-sm:text-left">
        <NuxtLink
          ...
          class="
            block m-xs
            no-underline text-fg-third hover:text-brand
            max-sm:ml-0
          "
        >
          {{ menu.title }}
        ...
        >
          ...
          >
            <g clip-path="url(#clip0_602_4)"><path
              ...
              fill="black"
              class="fill-fg-second group-hover:fill-brand"
            /></g>
