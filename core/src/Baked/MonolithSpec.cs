...
public abstract class MonolithSpec : Spec
{
    ...
    protected static void Init(
        ...
        Func<IdCodingStyleConfigurator, IFeature<IdCodingStyleConfigurator>>? idCodingStyle = default,
    ...
    )
    {
        ...
        idCodingStyle ??= c => c.AutoGenerated();
        ...
        Init(app =>
        {
            ...
            app.Features.AddIdCodingStyle(idCodingStyle);
