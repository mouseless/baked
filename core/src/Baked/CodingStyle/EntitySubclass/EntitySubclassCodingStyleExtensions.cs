...
public static class EntitySubclassCodingStyleExtensions
{
    ...
    {
        public EntitySubclassCodingStyleFeature EntitySubclass() =>
            new();
    }

    extension(TypeModel type)
    {
        public bool TryGetSubclassName([NotNullWhen(true)] out string? subclassName)
        {
        ...
        public bool TryGetEntityTypeFromSubclass(DomainModel domain, [NotNullWhen(true)] out TypeModel? entityType)
        {
            entityType = default;
