...
public static class LayerConfiguratorExtensions
{
    ...
    {
        public LayerConfigurator ALayerConfigurator<TTarget>(
        ...
        public LayerConfigurator ALayerConfigurator<TTarget1, TTarget2>(
            ApplicationContext? context = default,
        ...
        public LayerConfigurator ALayerConfigurator<TTarget1, TTarget2, TTarget3>(
            ApplicationContext? context = default,
            TTarget1? target1 = default,
            TTarget2? target2 = default,
        ...
        public LayerConfigurator ALayerConfigurator(
            ApplicationContext? context = default,
