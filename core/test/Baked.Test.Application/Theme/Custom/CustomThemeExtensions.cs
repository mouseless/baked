...
public static class CustomThemeExtensions
{
    public static CustomThemeFeature Custom(this ThemeConfigurator _) =>
        ...
        [
            ...
            r => r.ChildDynamic("/parents/[id]", "Parent", "/form-sample") with { Page = p => p.Generated(g => g.Type<Parent, SimplePage>()), Description = "Showcase a locatable entity page" },
            ...
            r => r.ChildDynamic("/route-parameters-sample/[id]", "Route Parameters", "/") with { Page = p => p.Generated(g => g.Type<RouteParametersSample, SimplePage>()), Description = "Showcases the route parameter support" },
