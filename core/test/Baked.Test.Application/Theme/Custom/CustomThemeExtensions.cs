...
public static class CustomThemeExtensions
{
    public static CustomThemeFeature Custom(this ThemeConfigurator _) =>
        ...
        [
            ...
            r => r.Dynamic("/route-parameters-sample/[id]", "Route Parameters") with { Page = p => p.Generated(g => g.Type<RouteParametersSample, ContainerPage>()), Description = "Showcases the route parameter support" },
            ...
            r => r.Child("/specs/query-bound-inputs", "Query Bound Inputs", "/specs") with { Icon = "pi pi-microchip", Description = "Syncs and manages parameters in query string", Section = "Behavior" },
