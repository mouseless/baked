...
public static class CustomThemeExtensions
{
    public static CustomThemeFeature Custom(this ThemeConfigurator _) =>
        ...
        [
            ...
            r => r.Child("/form-sample/new-parent", "New Parent", "/form-sample") with { Page = p => p.Generated(g => g.Method<FormSample, FormPage>(nameof(FormSample.NewParent))), SideMenu= false },
