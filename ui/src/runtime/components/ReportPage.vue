...
import { Bake, DeferredTabContent, QueryInputs, PageTitle } from "#components";
...
const { title, queryInputs, tabs } = schema;

const page = context.injectPage();
const ready = ref(queryInputs.length === 0);
const uniqueKey = ref();
