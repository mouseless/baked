...
public class LocalizeMessages : TestServiceNfr
{
    ...
    public async Task Localization_reads_culture_information_from_header()
    {
        ...
        var enResponse = await Client.PostAsync("localization-samples/read-culture-data-from-query-or-header", null);
        ...
        var trResponse = await Client.PostAsync("localization-samples/read-culture-data-from-query-or-header", null);
    ...
    {
        var enResponse = await Client.PostAsync("localization-samples/read-culture-data-from-query-or-header?culture=en", null);
        var enResult = await enResponse.Content.ReadAsStringAsync();

        enResult.ShouldBe("\"This is test message from English resource file.\"");

        var trResponse = await Client.PostAsync("localization-samples/read-culture-data-from-query-or-header?culture=tr", null);
        var trResult = await trResponse.Content.ReadAsStringAsync();
